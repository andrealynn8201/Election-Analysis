...
with open(file_to_save, "w") as txt_file:
    ...
    for county_name in county_votes:
        ...
        if (vote > lrg_county_vote) and (votes_percentage > lrg_county_voter):
            lrg_county_turnout = county_name
            lrg_county_vote = vote
            lrg_county_voter = votes_percentage
                

    # 7: Print the county with the largest turnout to the terminal.
    winning_county_summary = (
        f"\n------------------------\n"
        f"Largest Turnout : {lrg_county_turnout}\n"
        f"------------------------\n")
